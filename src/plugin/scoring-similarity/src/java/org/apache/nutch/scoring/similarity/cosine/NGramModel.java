...
public class NGramModel {
  ...
  public static synchronized void createModel(Configuration conf) throws IOException {
    ...
    try {
      ...
      n = Integer.parseInt(conf.get("scoring.similarity.ngrams"));
  ...
  public static DocVector createDocVector(String content) {
    ...
    tokenizer = new LuceneTokenizer(content, TokenizerType.STANDARD, false, 
          StemFilterType.PORTERSTEM_FILTER,n);

    TokenStream tStream = tokenizer.getNGramTokenStream();
